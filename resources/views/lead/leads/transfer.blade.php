    ...
    <div class="contentbar">
        ...
        <div class="card m-b-10">
            ...
            <div class="card-header lead_select">
                ...
                <form method="post" action="{{ route('lead.school.export') }}">
                    {{ csrf_field() }}
                    <div class="filter" style="display: flex">
                        ...
                        <div class="filter-item">
                            ...
                            <select class="form-control example" style="    width: 300px !important;  margin-top: 40px;"
                                name="school_id" class="form-control" required>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($school_transfer as $lead)
                ...
                {{ $school_transfer->render('pagination::bootstrap-4') }}
            </div>
        </div>
        {{-- </div> --}}
    </div>
