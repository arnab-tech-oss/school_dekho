        ...
        <div class="card m-b-10">
                ...
                <form method="get" action="{{ route('lead.lead.search') }}">
                    <div style="padding-left: 40px;">
                        <select name="counselor_id" id="" class="form-control" required>
                            ...
                            @foreach ($all_lead_locations as $counselor)
            ...
            <div class="row">
                <form style="margin-top: 10px;" class="d-flex   col" method="get"
                    action="{{ route('lead.export.location') }}">
                    <div style="width:300px; padding-left: 30px">
                        <select name="location" id="" class="form-control example" required>
                            <option value="">Select Location</option>
                            @foreach ($all_lead_locations as $location)
