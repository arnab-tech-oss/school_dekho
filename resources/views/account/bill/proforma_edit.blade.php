    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('lead.counselor.list') }}">Bill</a></li>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ route('account.add') }}" class="btn btn-primary">Proforma Bill Edit</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="contentbar">
        ...
        <div class="card m-b-10">
            <div class="card-header">
                <h5 class="card-title">Proforma Bill Edit</h5>
            </div>
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('account.proforma.update') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="school_gst_number" placeholder="Enter School GST Number"
                                value="{{ $bill_details?->school_gst_number }}">
                    ...
                    {{-- <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="payment_mode" id="pay_mode" class="form-control" onchange="Paymode()">
                                ...
                                <option value="cheque" @if ($bill_details?->payment_mode == 'cheque') selected @endif>Cheque</option>
                            </select>
