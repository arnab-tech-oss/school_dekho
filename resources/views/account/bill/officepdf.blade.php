...
<body class="container justify-center p-10">
    <div style=text-indent:0pt;text-align:left>
        <div class=flex>
            ...
            <div class="mx-auto text-center">
                <h1 class="text-3xl font-bold">TAX INVOICE</h1>
    ...
    @php
        ...
        $datetime_str = $bill->receipt_date;

        // Convert to a DateTime object and extract the date
        $receipt_date = \Carbon\Carbon::parse($datetime_str)->format('Y-m-d');
    @endphp
    ...
    <div class="flex justify-between border-t-4 border-t border-b-4 border-b">
        <div>RECEIPT DATE :  {{ $receipt_date }}</div>
        <div class="mr-20">INVOICE NUMBER : SD/SC/{{ $bill_id }}</div>
    </div>
    <table class="w-full table-auto">
        ...
        <tbody>
            ...
            <tr>
                <td class="px-3">School GST</td>
                <td class="px-3">:</td>
                <td class="px-3">{{ $bill?->gst_number_school }}</td>
            </tr>
        </tbody>
    </table>
    <p>
    ...
    <div class="grid right-2 justify-end w-auto">
        <div>
            Total Received : Rs. {{ $bill->newly_received }}/-
        </div>
        <div>
