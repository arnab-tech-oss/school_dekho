...
<div style="color:rgb(145, 0, 0)"
  class="text-9xl uppercase font-black absolute container top-[400px] text-red-500  justify-center w-full opacity-25 flex  ">
  <div class="w-full -rotate-45">Canceled</div>
</div>
