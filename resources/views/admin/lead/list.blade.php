...
<div class="contentbar">
    ...
    <div class="card m-b-10">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('admin.lead.export')}}">
                {{ csrf_field() }}
                <div class="filter">

                    <div class="filter-item">
                        <label for="select school">Select School</label>
                        <select class="form-control example" style="width: 400px;margin-top: 40px;" name="school_id" class="form-control" required>
            ...
            <table id="school-table" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ strtoupper($lead->lead_mode) }}</td>
                        <td>
