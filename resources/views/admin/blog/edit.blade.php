            ...
            <form action="{{ route('admin.blog.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="name" id="inputAddress" placeholder="Blog Title" value="{{$blog->title}}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control select2" id="blog_categories" name="blog_categories[]" multiple>
                            ...
                            <option value="{{$blogcategory->id}}" @if(in_array($blogcategory->id,$blog->blog_category_maps)) selected @endif>{{$blogcategory->name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="tags" style="width:100%" name="meta_keywords" id="inputAddress" placeholder="Blog Meta Keywords" value="{{$blog->meta_keywords}}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control select2" id="blog_tags" name="blog_tags[]" multiple>
                            ...
                            <option value="{{$blogtag->id}}" @if(in_array($blogtag->id,$blog->blog_tag_maps)) selected @endif>{{$blogtag->name}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="alt_image" class="form-control"
                                placeholder="Enter alt tag for image" value="{{ $blog->alt_image }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="tagImage">Image Title</label>
                            <input type="text" name="image_title" class="form-control"
                                placeholder="Enter title for image" value="{{ $blog->image_title }}">
                        </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-10">
                        <label for="inputAddress">Meta Description</label>
                        <textarea id="summernote" name="meta_description" class="form-control">{{$blog->meta_description}}</textarea>
                    </div>
                    <script>
                ...
                <div class="form-row">
                    <div class="form-group col-md-10">
                        ...
                        <textarea id="summernote2" name="blog_description" class="form-control">{{$blog->blog_description}}</textarea>
                    </div>
                    <script>
                ...
                <div class="form-row">
                   ...
                   <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="approaximate_time"
                                value="{{ $blog?->approaximate_time }}" placeholder="Enter approaximate time">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputAddress">Activate</label>
                        
                        <input type="checkbox" name="is_active" value={{$blog->is_active}} @if($blog->is_active) checked @endif>
