...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                @if (Auth::user()->role == 1)
                    @if ($schooldetails->status == "approved")
                        <a href="{{ route('admin.school.approve',[$schooldetails->id, 'pending']) }}" class="btn btn-primary-rgba"><i class="feather icon-check mr-2"></i>Approved</a>
                    @else
                        <a href="{{ route('admin.school.approve', [$schooldetails->id, 'approved']) }}" class="btn btn-danger-rgba"><i class="feather icon-x mr-2"></i>Pending</a>
                    @endif
                @else
                    @if ($schooldetails->status == "approved")
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-froup col-md-3">
                    <img src="{{asset('uploads')}}/images/{{$schooldetails->school_logo}}" height="100" width="100">
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-froup col-md-3">
                    <img src="{{asset('uploads')}}/images/{{$schooldetails->principal_pic}}" height="100" width="100">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-12">
    ...
    <div class="card m-b-24">
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    <a href="{{ route('admin.school.about.edit', $schoolcontact->id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card m-b-24"> 
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    <a href="{{ route('admin.school.eligibility.edit', $schooleligibility?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card m-b-24">
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    <a href="{{ route('admin.school.fees.edit', $schoolfees?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    </div>
                </div>
            </div>
        ...
        <div class="card-header">
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-4 ">
                        <div class="widgetbar">
                        <a href="{{ route('admin.school.hour.edit', $schoolseats?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card m-b-24">
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    <a href="{{ route('admin.school.image.edit', $schoolseats?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    </div>
                </div>
            </div>            
            <hr>
        ...
        <div class="card-body">
            <div class="form-row">
              @if($image=json_decode($schoolimages->school_image))
                @foreach($image as $image)
                <div class="form-row col-md-3">
                    <img src="{{asset('uploads')}}/images/{{$image}}" height="200" width="200">
                </div>
                @endforeach
              @endif
            </div>
    ...
    <div class="card m-b-24">
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    <a href="{{ route('admin.school.facility.edit', $schoolfeatures?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    </div>
                </div>
            </div>            
            <hr>            
