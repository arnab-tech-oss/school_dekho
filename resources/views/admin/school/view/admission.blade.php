        ...
        <div class="col-md-8 col-lg-8">
            ...
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Admission School</li>
                </ol>
            </div>
        </div>
...
<div class="contentbar">
    ...
    <div class="card m-b-10">
        <div class="card-header">
            <h5 class="card-title">Admission School</h5>
        </div>
        ...
        @endif
        <div class="card-body">
            <form action="{{ route('admin.school.admission.update') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control example" name="selected_schools[]" multiple>
                         @foreach($school_list as $school)
                            ...
                            selected
                            @endif>{{$school->name}}&nbsp;,{{$school->address}}</option>
                         @endforeach
                        </select>
