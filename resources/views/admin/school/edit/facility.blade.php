...
<!-- End Breadcrumbbar -->
<!-- Start Container -->
<form action="{{ route('admin.school.facility.update') }}" method="POST" enctype="multipart/form-data">
{{ csrf_field() }}
<div class="contentbar">
        <div class="card m-b-24">
            ...
            <?php 
            $education= array("Library","Career Counseling","Student Exchange","Digital Library","Counseling","Test Center");
...
<br>
   ...
   <br>
        <div class="card m-b-24">
            ...
            <?php 
            $sports=array("Play Area","Badminton","Cricket","Covered Play Area","Hockey","Football","Volleyball","Tennis","Kabaddi","Swimming","Table Tennis","Athletics","Gymnasium","Karate","Basket Ball");
            $sports1=array_fill(1,15,null);
            $i=1;
            ?>
            <div class="card-body">
                <div class="form-row">
...
<br>
    <div class="card m-b-24">
            ...
            <?php 
                $safety=array("CCTV","Fire Alarm","Fire Extinguisher","Security Guards","School Bus","Boundary Wall","Fenced Boundary Wall","Speedometer in Bus","GPS in Bus","CCTV in Bus","Fire Extinguisher in Bus","School Bus Tracking App");
                $safety1=array(1,12,null);
                $i=1;
            ?>
            <div class="card-body">
                <div class="form-row">
