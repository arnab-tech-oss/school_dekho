...
<div class="contentbar">
    ...
    <div class="card m-b-10">
        ...
        @endif
        <div class="card-body">
            <form action="{{ route('admin.school.add.new') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputAddress">Designation of the Principal</label>
                        <input type="text" class="form-control" name="principal_designation" id="inputAddress" placeholder="Enter Principal's Designation">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="exam" id="inputZip" placeholder="Enter Exam" required>
                    </div>
                </div>
