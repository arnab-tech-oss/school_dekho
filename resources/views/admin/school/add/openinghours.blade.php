                    ...
                    {{-- <div class="col-md-6"> --}}
                        <div class="card m-b-10">
                            ...
                            @if(Session::has('success'))
                                ...
                                @endif
                             <div class="card-body">
                                <form action="{{ route('admin.school.hours.new') }}" method="POST" enctype="multipart/form-data">
                                   {{ csrf_field() }}
                                   <div class="form-row">
                                   ...
                                   <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                           <button type="submit" name="action" value="Finish" class="btn btn-primary">Save &amp; Next</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
