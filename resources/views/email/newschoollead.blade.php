                ...
                <td align="left" style="padding-left: 10%; padding-right: 10%">
                    <div>
                        ...
                        <p style="text-align: justify">
                            A new lead is available for your school. To connect,
                            please sign-in to the School Profile
                            (Clickable link to https://schooldekho.org/).
                        </p>
                        <br />Thanks and Regards,<br />School Dekho,<br />
                        https://www.schooldekho.org/
                    </div>
                </td>
            </tr>
        </table>
