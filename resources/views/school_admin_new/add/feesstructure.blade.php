 ...
 @section('content')
     <div class="dashboard-content">
         <div class="container">
             <h4 class="dashboard-title">Update Details: <span class="text-primary">Stem World School</span></h4>
             ...
             <div class="dashboard-settings">
                 ...
                 <div class="dashboard-tabs-menu">
                     <ul>
                         ...
                         <li><a href="{{ route('schooladmin.eligibility.details') }}">Eligibility</a>
                         </li>
                         <li><a class="active" href="{{ route('schooladmin.fees.details') }}">Fees Structure</a></li>
