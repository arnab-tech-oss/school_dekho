...
<head>
    ...
    @if (isset($schooldetails->name) && isset($schoolcontacts))
        ...
        <meta name="description"
            content="{{ "$schoolName Best,top," . ($boardName == 'CISCE' ? 'ICSE' : '') . "$boardName school $city, $schoolcontacts->states->state, $schoolName,best school near me.School Dekho" }}" />
    ...
    <script type='application/ld+json'>
    {
      ...
      "sameAs": [
        "https://www.facebook.com/MySchoolDekho/",
        "https://www.linkedin.com/company/school-dekho/",
        "https://twitter.com/dekho_school"
      ]
    }
  </script>
    <script type="application/ld+json">
