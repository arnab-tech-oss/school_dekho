                                ...
                                {{-- <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn" type="submit" id="button-addon2"><img
                                                ...
                                                alt="School Dekho, India's first search engine for school admissions, Dekho Phir Chuno, best school near me"></button>
                                    </div>
                                </div> --}}
                            </form>
                        </div>
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            {{-- <li class="media dropdown-item">
                                                <a href="#" class="profile-icon"><img
                                                        ...
                                                        class="img-fluid"
                                                        alt="School Dekho, India's first search engine for school admissions, Dekho Phir Chuno, best school near me">Email</a>
                                            </li> --}}
                                            <li class="media dropdown-item">
                                                <a href="{{ route('admin.logout.perform') }}" class="profile-icon"><img
