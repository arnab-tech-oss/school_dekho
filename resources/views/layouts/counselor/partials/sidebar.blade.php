<div class="leftbar">
    ...
    <div class="sidebar">
        <!-- Start Logobar -->
        <div class="logobar">
            <a href="{{ route('counselor.dashboard') }}" class="logo logo-large"><img
            ...
            <a href="{{ route('counselor.dashboard') }}" class="logo logo-small"><img
            ...
            <ul class="vertical-menu">
                ...
                <li>
                    ...
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('counselor.new.leads') }}"> New Leads</a></li>
                        <li><a href="{{ route('counselor.old.leads') }}"> Old Leads</a></li>
                        <li><a href="{{ route('counselor.interested.leads') }}">Interested Leads</a></li>
                        <li><a href="{{ route('counselor.pending.leads') }}">Pending Leads</a></li>
                        <li><a href="{{ route('counselor.lead.followup') }}">Followup Leads</a></li>
                        <li><a href="{{ route('counselor.lead.admission') }}">Admitted Leads</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javaScript:void();">
