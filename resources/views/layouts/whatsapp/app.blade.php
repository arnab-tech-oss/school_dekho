...
<body class="vertical-layout">
    ...
    <div id="containerbar">
        <!-- Start Leftbar -->
        @include('layouts.whatsapp.partials.sidebar')
        <!-- End Leftbar -->
        <!-- Start Rightbar -->
        <div class="rightbar">
            <!-- Start Topbar Mobile -->
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="mobile-logobar">
                            <a href="index-2.html" class="mobile-logo"><img
            ...
            <!-- Start Topbar -->
            @include('layouts.whatsapp.partials.header')
            <!-- End Topbar -->
            <!-- Start Breadcrumbbar -->
            <!-- End Breadcrumbbar -->
            <!-- Start Contentbar -->
            ...
            <!-- End Contentbar -->
            <!-- Start Footerbar -->
            @include('layouts.whatsapp.partials.footer')
            <!-- End Footerbar -->
        </div>
        <!-- End Rightbar -->
    </div>
