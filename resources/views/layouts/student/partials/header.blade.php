                        ...
                        <div class="userbox">
                            <ul class="list-unstyled mb-0">
                                <li class="media dropdown-item">
                                    <a href="{{ route('student.logout') }}" class="profile-icon"><img src="{{asset('assets')}}/images/svg-icon/logout.svg" class="img-fluid" alt="School Dekho, India's first search engine for school admissions, Dekho Phir Chuno, best school near me">Logout</a>
                                </li>
                            </ul>
                        </div>
                    </div>
