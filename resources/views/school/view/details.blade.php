        ...
        <div class="col-md-7 col-lg-7">
            ...
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('school.list') }}">Schools</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Details</li>
                </ol>
            </div>
        </div>
        <div class="col-md-5 col-lg-5 form-row">
            <div class="widgetbar">
                @if ($schooldetails->is_verify == 1)
                <a href="#" class="btn btn-success-rgba"><i class="feather icon-check mr-2"></i>Approved</a>
                @elseif($schooldetails->is_verify == 0)
                    @if($is_claimed)
                        <a href="{{ route('school.claim', $schooldetails?->id) }}" class="btn btn-primary-rgba"><i class="feather icon-x mr-2"></i>Verification pending</a>
                    @else
                    <a href="{{ route('school.claim', $schooldetails?->id) }}" class="btn btn-primary-rgba"><i class="feather icon-x mr-2"></i>Claim this school</a>
                    @endif
                
                @elseif($schooldetails->is_verify == 0 && !$is_claimed) 
                <a href="#" class="btn btn-danger-rgba"><i class="feather icon-x mr-2"></i>Pending Approval</a>
                @endif 
                {{-- <form method="post" action="{{route('school.pay')}}">
                    {{ csrf_field() }}
                    <input type="hidden" name="school_id" value="{{$schooldetails->id}}"/>
                    @if($is_verified && !$is_subscribed)
            ...
            <div class="widgetbar" style="padding-left:20px ;">
                @if($is_verified_other && !$is_own_verified_owner)
                <a href="#" class="btn btn-primary-rgba"><i class="feather icon-check mr-2">Claim By Others</i></a>
                @endif
            </div>
        </div>
...
<div class="contentbar">
    ...
    <div class="card m-b-24">
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                        @if(sizeof($is_subscribed) && sizeof($payment_status)>0)
                        <a href="{{ route('school.info.edit', $schooldetails->id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    @if(sizeof($is_subscribed) && sizeof($payment_status)>0)
                        <a href="{{ route('school.about.edit', $schooldetails->id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    @endif    
                    </div>
                </div>
            </div>
        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    @if(sizeof($is_subscribed)&& sizeof($payment_status)>0)
                        <a href="{{ route('school.eligibility.edit', $schooleligibility?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    @endif    
                    </div>
                </div>
            </div>
    ...
    {{--<div class="card m-b-24">
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    @if($schoolclaimstatus)
                        <a href="{{ route('school.academic.edit', $schooldetails->id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    @endif
                    </div>
                </div>
            </div>
    ...
    <div class="card m-b-24">
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    @if(sizeof($is_subscribed))
                        <a href="{{ route('school.fees.edit', $schoolfees?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    @endif
                    </div>
                </div>
            </div>
        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    @if(sizeof($is_subscribed))
                        <a href="{{ route('school.seat.edit', $schoolseats?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    @endif
                    </div>
                </div>
            </div>
            ...
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-4 ">
                        <div class="widgetbar">
                        @if(sizeof($is_subscribed)&& sizeof($payment_status)>0)
                            <a href="{{ route('school.hour.edit', $schoolseats?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                        @endif
                        </div>
                    </div>
                </div>
    ...
    <div class="card m-b-24">
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    @if(sizeof($is_subscribed)&& sizeof($payment_status)>0)
                        <a href="{{ route('school.image.edit', $schoolseats?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    @endif
                    </div>
                </div>
            </div>
        ...
        <div class="card-body">
            <div class="form-row">
                @if($image=$schoolimages->school_image)
        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-lg-4 ">
                    <div class="widgetbar">
                    @if(sizeof($is_subscribed)&& sizeof($payment_status)>0)
                        <a href="{{ route('school.facility.edit', $schoolfeatures?->school_id) }}" class="btn btn-primary-rgba"><i class="feather icon-edit mr-2"></i>Edit</a>
                    @endif
                    </div>
                </div>
            </div>
