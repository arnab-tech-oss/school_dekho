                            ...
                            <select id="inputState" class="form-control" name="category" required>
                                ...
                                @foreach ($allcategory as $category)
                                    <option value="{{ $category->id }}"
                                        @if ($school->categories->id == $category->id) echo "selected"; @endif>{{ $category->category }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select id="inputState" class="form-control" name="board" required>
                                ...
                                @foreach ($allboards as $boards)
                                    <option value="{{ $boards?->id }}"
                                        @if ($school->boards?->id == $boards?->id) echo "selected"; @endif>
                            ...
                            <select id="inputState" class="form-control" name="school_medium_id" required>
                                ...
                                @foreach ($allmedium as $medium)
                                    <option value="{{ $medium?->id }}"
                                        @if ($school?->medium?->id == $medium?->id) echo "selected"; @endif>{{ $medium?->medium }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="school_type">
                                ...
                                <option value="Boys" @if ($school->school_type == "boys") echo "selected"; @endif>Boys
                                </option>
                                <option value="Girls" @if ($school->school_type == "girls") echo "selected"; @endif>Girls
                                </option>
                                <option value="Co-Ed" @if ($school->school_type == "co-ed") echo "selected"; @endif>Co-ed
                                </option>
                            </select>
                        </div>
                    </div>
