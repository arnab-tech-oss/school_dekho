...
{{-- <div class="col-md-6"> --}}
    <div class="card m-b-10">
        ...
        @endif
        <div class="card-body">
            <form action="{{ route('school.about.update') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="city" id="inputZip" placeholder="Enter City" value="{{$schoolcontacts->city}}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select id="inputState" class="form-control" name="district_id" required>
                            ...
                            <option value="{{$district?->id}}" @if($district?->id == $schoolcontacts?->districts?->id) echo "selected"; @endif>{{$district?->district}}</option>
                            @endforeach
                        </select>
