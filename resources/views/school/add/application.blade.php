            ...
            <div class="col-md-8 col-lg-8">
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Application Form</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="contentbar" ng-app="myApp" ng-controller="myCtrl">
        ...
        <div class="card m-b-10">
            ...
            <div class="card-header">
                ...
                <div>
                    <input id="school_id" type="hidden" value="{{ $school_id }}" />
                                ...
                                <form ng-submit="controlSubmit()">
                                    <div class="form-row">
                                        <!-- <div class="form-group col-md-6">
                                                ...
                                                <input id="inputEmail4" type="text" class="form-control" placeholder="Enter name of the field" ng-model="name">
                                            </div> -->

                                        <div class="form-group col-md-6">
                                            <label>Name of Field Label</label>
                                            <input id="inputEmail4" type="text" class="form-control"
                                    ...
                                    <div class="form-row" ng-show="type=='select' || type=='checkbox' || type=='radio'">
