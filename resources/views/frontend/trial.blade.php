@php
  $partnerLogos = [
      [
          'url' => 'https://republicnewstoday.com/index.php/2022/08/15/indias-first-search-engine-for-school-admission-schooldekho-org-is-helping-parents-find-the-best-schools/',
          'image' => 'republicnewstoday.webp',
          'alt' => 'Republic News Today Logo',
      ],
      [
          'url' => 'https://asiannews.in/indias-first-search-engine-for-school-admission-schooldekho-org-is-helping-parents-find-the-best-schools/',
          'image' => 'asiannews.webp',
          'alt' => 'Asian News Logo',
      ],
      [
          'url' => 'https://news.google.com/search?q=India%27s%20first%20search%20engine%20for%20school%20admission&hl=en-IN&gl=IN&ceid=IN%3Aen',
          'image' => 'googlenews.webp',
          'alt' => 'Google News Logo',
      ],
      [
          'url' => 'https://jionews.com/home/article/173/1795345448/India%E2%80%99s-First-Search-Engine-for-School-Admission-%E2%80%9Cschooldekhoorg%E2%80%9D-Is-Helping-Parents-Find-the-Best-Schools',
          'image' => 'jionews.webp',
          'alt' => 'Jio News Logo',
      ],
      [
          'url' => 'https://dailyhunt.in/news/india/english/ani+english-epaper-anieng/indias+first+search+engine+for+school+admission+schooldekhoorg+is+helping+parents+find+the+best+schools-newsid-n413217308?ss=wsp&s=i&uu=0xb2af503d36c6d6e8',
      ...
      [
          'url' => 'https://theprint.in/ani-press-releases/indias-first-search-engine-for-school-admission-schooldekho-org-is-helping-parents-find-the-best-schools/1081487/',
          'image' => 'theprint.webp',
          'alt' => 'The Print Logo',
      ],
      [
          'url' => 'https://www.zee5.com/articles/indias-first-search-engine-for-school-admission-schooldekho-org-is-helping-parents-find-the-best-schools',
          'image' => 'zee5.webp',
          'alt' => 'Zee5 Logo',
      ],
      [
          'url' => 'https://www.westbengalkhabar.in/news/indias-first-search-engine-for-school-admission-schooldekhoorg-is-helping-parents-find-the-best-schools20220813174301/',
          ...
          <div class="col-md-6">
            <div class="slider-image">
              <div class="slider-image__image text-lg-end text-center" data-aos="fade-up" data-aos-duration="1000">
                <img src="{{ asset('assets/images/sd_index.webp') }}" alt="Hero Image" style="border-radius: 30px;"
      ...
      <div class="row">
        <div class="col-sm-8">
          <div class="section-title" data-aos="fade-up" data-aos-duration="1000">
            <h2 class="section-title__title-03"><mark>Recommended12</mark> Schools</h2>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="section-btn-02 text-sm-end" data-aos="fade-up" data-aos-duration="1000">
            <a class="btn btn-light btn-hover-primary" href="javascript:void();"
              onclick="getNearBySchoolsWithLocationCheck()">View All <i class="far fa-long-arrow-right"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="row gy-10 align-items-center justify-content-center">
        ...
        <div class="col-lg-4 col-md-8 col-sm-10">
          <div class="countdown-register text-center" data-aos="fade-up" data-aos-duration="1000">
            ...
            <p class="small pt-2">
              You are already the
              <span style="font-weight: 600; font-size: 12px" class="text-primary">{{ $result }}<sup>th</sup>
              </span>
  ...
  <div class="event-section section-padding-01">
    <div class="container">
      <div class="row">
        <div class="col-sm-8">
          <div class="section-title" data-aos="fade-up" data-aos-duration="1000">
            <h2 class="section-title__title-03">Recent <mark>Articlesaa</mark></h2>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="section-btn-02 text-sm-end" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="partner-logo">
                  <div class="partner-logo__logo">
                    <a {{-- href="{{ $logo['url'] }}" --}} target="_blank">
                      <img src="{{ asset('assets/school/images/news/' . $logo['image']) }}" alt="{{ $logo['alt'] }}">
                    </a>
                  </div>
                </div>
              </div>
