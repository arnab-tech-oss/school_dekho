@php
    $partnerLogos = [
        [
            'url' =>
                'https://asiannews.in/indias-first-search-engine-for-school-admission-schooldekho-org-is-helping-parents-find-the-best-schools/',
            'image' => 'asiannews.webp',
            'alt' => 'Asian News Logo',
        ],
        [
            'url' =>
                'https://news.google.com/search?q=India%27s%20first%20search%20engine%20for%20school%20admission&hl=en-IN&gl=IN&ceid=IN%3Aen',
            'image' => 'googlenews.webp',
            'alt' => 'Google News Logo',
        ],
        [
            'url' =>
                'https://jionews.com/home/article/173/1795345448/India%E2%80%99s-First-Search-Engine-for-School-Admission-%E2%80%9Cschooldekhoorg%E2%80%9D-Is-Helping-Parents-Find-the-Best-Schools',
            'image' => 'jionews.webp',
            'alt' => 'Jio News Logo',
        ],
        [
            'url' =>
                'https://dailyhunt.in/news/india/english/ani+english-epaper-anieng/indias+first+search+engine+for+school+admission+schooldekhoorg+is+helping+parents+find+the+best+schools-newsid-n413217308?ss=wsp&s=i&uu=0xb2af503d36c6d6e8',
        ...
        [
            'url' =>
                'https://theprint.in/ani-press-releases/indias-first-search-engine-for-school-admission-schooldekho-org-is-helping-parents-find-the-best-schools/1081487/',
            'image' => 'theprint.webp',
            'alt' => 'The Print Logo',
        ],
        [
            'url' =>
                'https://www.zee5.com/articles/indias-first-search-engine-for-school-admission-schooldekho-org-is-helping-parents-find-the-best-schools',
            'image' => 'zee5.webp',
            'alt' => 'Zee5 Logo',
        ],
        [
            'url' =>
                'https://republicnewstoday.com/index.php/2022/08/15/indias-first-search-engine-for-school-admission-schooldekho-org-is-helping-parents-find-the-best-schools/',
            'image' => 'republicnewstoday.webp',
            'alt' => 'Republic News Today Logo',
        ],
        [
            'url' =>
                'https://www.westbengalkhabar.in/news/indias-first-search-engine-for-school-admission-schooldekhoorg-is-helping-parents-find-the-best-schools20220813174301/',
            'image' => 'WB_samachar.webp',
            'alt' => 'WB Samachar Logo',
        ],
        [
            'url' => '#',
            'image' => 'ani news.webp',
                  ...
                  <button class="slider-search__submit" type="submit">
                            ...
                            <div class="call-to-action__content" data-aos="fade-up" data-aos-duration="1000">
                                <div class="call-to-action__caption">
                                    <h3 class="call-to-action__sub-title"><i class="far fa-school"></i>
                                        Local
                                        Schools</h3>
                                    <h3 class="call-to-action__main-title">Find Schools Near Me</h3>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="slider-image">
                            <div class="slider-image__image text-lg-end text-center" data-aos="fade-up"
                                data-aos-duration="1000">
                                <img src="{{ asset('assets/images/sd_index.webp') }}" alt="Hero Image"
                                    style="border-radius: 30px;" width="599" height="480">
                            </div>
                            {{-- <style>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="section-btn-02 text-sm-end" data-aos="fade-up" data-aos-duration="1000">
                        <a class="btn btn-light btn-hover-primary" href="javascript:void();"
                            onclick="getNearBySchoolsWithLocationCheck()">View All <i
                ...
                <div class="col-lg-4 col-md-8 col-sm-10">
                    <div class="countdown-image scene text-center" data-aos="fade-up" data-aos-duration="1000">
                        <div class="countdown-image__image">
                            <img src="{{ asset('assets/school/images/Somnath Sir.svg') }}" alt="resourse image"
                                width="346">
                        </div>
                        ...
                        <form id="RequestCallbackForm" class="setting-form" method="POST"
                            ...
                            <div class="countdown-register__form">
                                ...
                                <div class="countdown-register__input">
                                    ...
                                    <input style="padding-left: 80px; " class="form-control" name="phone"
                                        type="text" required>
                                ...
                                <div class="countdown-register__btn">
                                    <button id="submitButton" class="btn btn-primary btn-hover-secondary w-100"
                                        disabled>Submit</button>
                                </div>
                            </div>
                        </form>
                        @php
                            function increaseNumberByDaysElapsed($initialNumber, $startDate)
                            {
                                // Calculate the number of days elapsed since the start date
                                $currentDate = time();
                                $daysElapsed = floor(($currentDate - strtotime($startDate)) / (60 * 60 * 24));
                                // Increase the initial number by the number of days elapsed
                                $increasedNumber = $initialNumber + $daysElapsed;
                                return $increasedNumber;
                            }
                            // Example usage
                            $initialNumber = $total_number_rows + 2000;
                            $startDate = '2023-01-01'; // Format: 'YYYY-MM-DD'
                            // Get the increased number based on the current date
                            $result = increaseNumberByDaysElapsed($initialNumber, $startDate);
                        @endphp
                        <p class="small pt-2">
                            You are already the
                            <span style="font-weight: 600; font-size: 12px"
                                class="text-primary">{{ $result }}<sup>th</sup>
                            </span>
                            ...
                            <div class="swiper-slide">
                                <div class="event-item-02">
                                    <div class="event-item-02__image">
                                        ...
                                        <span
                                            class="event-item-02__date">{{ App\Core\Helper::GetDate($blog->created_at) }}</span>
                                    </div>
        ...
        <div class="container">
            ...
            <div style="max-height: 330px;" class="testimonial-active-02" data-aos="fade-up" data-aos-duration="1000">
              ...
              height: 331px;" class="testimonial-item bg-white">
                                ...
                                <div class="testimonial-main-content">
                                    <div class="testimonial-caption content-item">
                                        <h3 class="testimonial-caption__title">A Guardian's Guide to Finding the Best
                                            School</h3>
                                        <p>With its vast database of schools, detailed information, and ratings, it's the
                                            perfect tool for
    ...
    <div class="partners-seaction section-padding-02">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <div class="section-title" data-aos="fade-up" data-aos-duration="1000">
                        <h2 class="section-title__title-03">School Dekho <mark>Featured</mark> on</h2>
                    </div>
                </div>
                {{-- <div class="col-sm-4">
        <div class="section-btn-02 text-sm-end" data-aos="fade-up" data-aos-duration="1000">
                                    ...
                                    <div class="partner-logo__logo">
                                        <a {{-- href="{{ $logo['url'] }}" --}} target="_blank">
                                            <img style="max-height: 100px"
                                                src="{{ asset('assets/school/images/news/' . $logo['image']) }}"
                                                alt="{{ $logo['alt'] }}">
                                        </a>
                                    </div>
                                </div>
    ...
    <div class="banner-section section-padding-01">
        <div class="container">
            ...
            <div class="banner-big-box banner-bg-4" data-aos="fade-up" data-aos-duration="1000">
                <img class="banner-big-box__arrow" src="{{ asset('assets/school/images/curve-arrow.png') }}"
                    alt="arrow" width="50" height="45">
                ...
                <div class="banner-big-box__image"
                    style="background-image: url({{ asset('assets/school/images/sd_banner-1.webp') }});">
                </div>
            </div>
            <!-- Banner Box End -->
        </div>
                    ...
                    <div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="counter-item-03">
                            <div class="counter-item-03__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="80px" height="74px" viewBox="0 0 80 74">
                                    <path
                            ...
                            <div class="counter-item-03__content"> <span class="counter-item-03__count count"
                                    data-count="{{ $school_count }}">0</span>
          ...
          <!-- Counter Item End -->
                    ...
                    <div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="counter-item-03">
                            <div class="counter-item-03__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="90px" height="61px" viewBox="0 0 90 61">
                            ...
                            <div class="counter-item-03__content"> <span class="counter-item-03__count"><span
                                        class="count" data-count="{{ $total_enquiries }}">0</span>+</span>
                    ...
                    <div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="counter-item-03">
                            <div class="counter-item-03__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="80px" height="77px" viewBox="0 0 80 77">
                                    <path
                            ...
                            <div class="counter-item-03__content"> <span class="counter-item-03__count"><span
                                        class="count" data-count="{{ $counselled_enquiries }}">0</span>+</span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function checkForm() {
                ...
                const hasErrors = !!nameError.textContent || !!phoneError.textContent || !!pincodeError
                    .textContent || !!
                    seekingClassError.textContent;
