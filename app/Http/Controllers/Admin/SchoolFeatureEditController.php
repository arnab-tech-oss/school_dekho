...
class SchoolFeatureEditController extends BaseAdminController
{
    ...
    {   
        ...
        if(!$schoolcontacts)
        {
            ...
            $school_contact->school_id = $id;
            $school_contact->save();
            $schoolcontacts=$school_contact;
            
        }
        return view('admin.school.edit.contact', compact('allstates', 'alldistricts', 'schoolcontacts'));
    }
    ...
    public function updateaboutschool(Request $request)
    {
        ...
        $entity->lattitude = $request->lattitude;
        ...
        return redirect()->route('admin.school.details', $request->school_id);
    }
    ...
    { 
        ...
        // dd($school);
        return view('admin.school.edit.about', compact('allboards', 'allmedium', 'allcategory', 'school'));
    }
    ...
    public function updateschool(Request $request)
    {
        ...
        return redirect()->route('admin.school.details', $request->id);
    }

    public function editschooleligibility($id)
    {
        $schooleligibility = SchoolEligibility::where("school_id", $id)->first();
        return view('admin.school.edit.eligibility', compact('schooleligibility'));
    }

    public function updateschooleligibility(Request $request)
    {
        $entity = new SchoolEligibility(); 
        $entity->max_qualification = $request->max_qualification;
        $entity->min_qualification = $request->min_qualification;
    ...
    public function academicperformance($id)
    {
        ...
        return view('admin.school.edit.academic', compact('academics', 'id'));
    }
    ...
    public function feesstructure($id)
    {
        ...
        return view('admin.school.edit.fees', compact('schoolfees'));
    }
    ...
    public function seatavailable($id)
    {
        ...
        return view('admin.school.edit.seat', compact('seats'));
    }
    ...
    public function openhour($id)
    {
        ...
        return view('admin.school.edit.hours', compact('hour'));
    }
    ...
    public function facilities($id)
    {
        ...
        return view('admin.school.edit.facility', compact('facility'));
    }
    ...
    public function images($id)
    {
        ...
        return view('admin.school.edit.images', compact('images'));
    }
    public function imageupdate(Request $request)
    {   
        $validator = Validator::make($request->all(), array(
            "position" => "required",
            "file" => "required|image|dimensions:width=400,height=400",
            "id" => "required",
        ));
        ...
        if ($validator->fails()) {
            ...
            $this->response->message="Please Upload your image atleast 400x400 resolution";
            return $this->rModel();
        }
    ...
    public function imagedelete(Request $request)
    {
        ...
        $filename = $images[$request->position];
        FileHelper::Delete($filename,FileHelper::$gallery);
